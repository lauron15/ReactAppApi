...
using ReactAppApi.Server.Service;
...
//Here we are going to use a code that's going to enable JWT tests on swagger
// Right now, we can see an option for "Authorized" on swagger. 
